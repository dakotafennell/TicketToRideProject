...
public class TicketToRide extends Application
{
    ...
    //Constant for the max cards per turn
    public static final int MAX_CARDS_PER_TURN = 2;
    ...
    private static ImageView getImageView() throws MalformedURLException
    {
    ...
    private void createGameInterface(Stage primaryStage)
    {
        ...
        try
        {
            ...
            String imageUrl = Objects.requireNonNull(getClass().getResource("/com/example/tickettoride/TransportCards/BackTransportationCard.png")).toExternalForm();
            // Set the button's background to the image
        ...
        //-------------------- Event handler for the destination card button ----------------------\\
        //Set Button Action
        ...
        //----------------- End of event handler for the destination card button -------------------\\
        ...
        //----------------------------------------------------------------------\\
        Display playersHand = new Display(currentPlayers);

        //Moving the below functions to the Display class
        VBox cardImagesVBox = playersHand.displayPlayersHand();
